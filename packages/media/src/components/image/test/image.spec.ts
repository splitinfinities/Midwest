...
describe('midwest-image', () => {
	it('should render and respond to changes appropriately', async () => {
		const page = await newSpecPage({
			components: [Picture],
			html: `<midwest-image width="2792" height="1574" preload="./global/images/_images/google_cardboard_will@2x-76x43.jpg">
		...
		expect(page.root).toEqualHtml(`
			<midwest-image height=\"1574\" preload=\"./global/images/_images/google_cardboard_will@2x-76x43.jpg\" type=\"picture\" width=\"2792\" style=\"--background-image: url('undefined'); --aspect-ratio: 56.375358166189116%; --width: 2792px; --height: 1574px;\">
				<mock:shadow-root>
