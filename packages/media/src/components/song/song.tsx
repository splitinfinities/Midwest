...
import { leadingZeroIndex, relPathAsAbs } from "@midwest-design/common";
...
export class Song {
	...
	@State() player: HTMLMidwestPlaylistElement | any;
	@State() title: string;
	@State() album: string;
	@State() artist: string;
	@State() genre: string;
	...
	async componentWillLoad() {
		this.player = this.element.closest('midwest-playlist');
		if (this.player.load) {
			this.load()
		}
