...
import { get_interview_lines, update_interview_lines } from './vendor/helpers';
import delay from 'async-delay';
import "ionicons";

@Component({
  tag: 'midwest-interview',
    ...
    return (
      <div class="card" onDblClick={() => { this.handleClick() }}>
        ...
        {this.visible && <section>
          ...
          <midwest-progress value={this.current} max={this.duration} noease={true} blurable={false} slender={true} editable={true} onUpdate={(e) => { this.skipTo(e.detail.value) }} />
        </section>}
