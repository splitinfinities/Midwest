...
const AnimateText = class {
    ...
    render() {
        return index.h(index.Host, { role: "text", ariaLabel: this.originalText }, index.h("midwest-intersection", { element: this.element, multiple: true, in: this.in.bind(this), out: this.out.bind(this) }));
    }
    get element() { return index.getElement(this); }
};
AnimateText.style = animateTextCss;

exports.midwest_animate_text = AnimateText;
