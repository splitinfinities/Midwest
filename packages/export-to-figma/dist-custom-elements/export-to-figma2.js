...
let ExportToFigma = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
ExportToFigma = /*@__PURE__*/ proxyCustomElement(ExportToFigma, [1, "export-to-figma", {
    "noKey": [4, "no-key"],
    "element": [1040],
    "export": [64]
  }, [[8, "keydown", "handleSaveComponents"]]]);
function defineCustomElement() {
  const components = ["export-to-figma"];
  components.forEach(tagName => { switch (tagName) {
    case "export-to-figma":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ExportToFigma);
      }
      break;
  } });
}
...
export { ExportToFigma as E, defineCustomElement as d };

//# sourceMappingURL=export-to-figma2.js.map