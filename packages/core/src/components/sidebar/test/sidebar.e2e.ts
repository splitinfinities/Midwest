...
describe('midwest-sidebar', () => {
  it('renders', async () => {
    ...
    await page.setContent('<link href="/build/design-system.css" rel="stylesheet" /><midwest-sidebar></midwest-sidebar>');
  ...
  it('renders changes to the type', async () => {
    ...
    await page.setContent('<link href="/build/design-system.css" rel="stylesheet" /><midwest-sidebar type="error"><p>Oh god no why!</p></midwest-sidebar>');
    const element = await page.find('midwest-sidebar');
