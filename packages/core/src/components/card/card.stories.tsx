...
export default {
  title: '@midwest-design/core/card',
...
export const WebComponent = ({ front, back, ...args }) => html`<midwest-card>
...
export const full = ({ front, back, ...args }) => html`<midwest-card style="max-width: 30rem;" class="m-auto">
  ...
  <footer class="bg-gray-1">
    <h6 class="text-red-5">Context</h6>
    <p class="text-gray-9">Lorem ipsum dolor sit, amet consectetur adipisicing elit.</p>
  </footer>
