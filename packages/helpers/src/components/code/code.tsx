...
export class Code {
  ...
  render() {
    if (this.simple) {
      ...
      const FooterTag = !!this.preview ? 'footer' : 'section';
      ...
      return (
        <midwest-card padding="small">
          ...
          <FooterTag class="code flush">
            {this.copy && (
              <midwest-button tag="button" class="copy" ghost onClick={this.clipboard.bind(this)}>
