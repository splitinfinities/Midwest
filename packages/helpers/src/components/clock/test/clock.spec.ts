...
describe('midwest-clock', () => {
  it('should render and respond to changes appropriately', async () => {
    const page = await newSpecPage({
      components: [Clock],
      html: `<midwest-clock time="12/12/20 12:00:00 pm"></midwest-itclockem>`,
    });
    expect(page.root).toEqualHtml(`
       <midwest-clock time="12/12/20 12:00:00 pm" style=\"--size: 200px;\">
      <mock:shadow-root>
        <svg viewBox=\"0 0 200 200\">
          <g>
            <circle cx=\"100\" cy=\"100\" id=\"circle\" r=\"95\" style=\"stroke: var(--theme-5); stroke-width: 4px; fill: var(--theme-0);\"></circle>
          </g>
        ...
        <svg class=\"above\" viewBox=\"0 0 200 200\">
          <g>
            <line id=\"hourhand\" transform=\"rotate(180 100 100)\" x1=\"100\" x2=\"100\" y1=\"100\" y2=\"140\" style=\"stroke-width: 6px; stroke: var(--theme-9);\"></line>
            <line id=\"minutehand\" transform=\"rotate(-180 100 100)\" x1=\"100\" x2=\"100\" y1=\"100\" y2=\"160\" style=\"stroke-width: 8px; stroke: var(--theme-7);\"></line>
            <line id=\"secondhand\" transform=\"rotate(-180 100 100)\" x1=\"100\" x2=\"100\" y1=\"100\" y2=\"180\" style=\"stroke-width: 4px; stroke: var(--theme-3);\"></line>
          </g>
          <circle cx=\"100\" cy=\"100\" id=\"center\" r=\"4\" style=\"fill: var(--theme-0); stroke: var(--theme-3); stroke-width: 5px;\"></circle>
        </svg>
