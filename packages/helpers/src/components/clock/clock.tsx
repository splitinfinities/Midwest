...
export class Clock {
  ...
  handleBetween() {
    if (this.between) {
      ...
      if (this.element.shadowRoot.querySelector("midwest-chart")) {
        this.element.shadowRoot.querySelector("midwest-chart").options(this.chartConfig);
      }
    }
  }
    ...
    return (
      <Host style={{ "--size": `${this.size}px` }}>
        <svg viewBox={`0 0 ${this.size} ${this.size}`}>
          <g>
            <circle id="circle" style={{ "stroke": "var(--theme-5)", "stroke-width": `${this.size * .02}px`, "fill": "var(--theme-0)" }} cx={this.size / 2} cy={this.size / 2} r={this.size / 2 * .95}></circle>
          </g>
        ...
        <midwest-chart type="pie" id="chart" class={this.between ? "db" : "dn"} />
        ...
        <svg class="above" viewBox={`0 0 ${this.size} ${this.size}`}>
          <g>
            <line
              ...
              style={{ "stroke-width": `${this.size * .03}px`, "stroke": "var(--theme-9)" }}
              id="hourhand"
            />
            ...
            <line
              ...
              style={{ "stroke-width": `${this.size * .04}px`, "stroke": "var(--theme-7)" }}
              id="minutehand"
            />
            ...
            <line
              ...
              style={{ "stroke-width": `${this.size * .02}px`, "stroke": "var(--theme-3)" }}
              id="secondhand"
            />
          </g>
          ...
          <circle
            id="center"
            style={{ "fill": "var(--theme-0)", "stroke": "var(--theme-3)", "stroke-width": `5px` }}
            cx={this.size / 2}
            cy={this.size / 2}
            r={this.size * .02}
          />
